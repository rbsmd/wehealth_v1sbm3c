      ...
      <c:forEach var="itemsVO" items="${list }">
        ...
        <tr> 
          ...
          <td style='vertical-align: middle;'>
            <a href="./read.do?itemsno=${itemsno}"><strong>${itemsVO.item_name}</strong> ${itemsVO.content}</a> 
          </td> 
          <td style='vertical-align: middle; text-align: center;'>
            <del><fmt:formatNumber value="${itemsVO.item_price}" pattern="#,###" /></del><br>
            <span style="color: #FF0000; font-size: 1.2em;">${itemsVO.discount} %</span>
            <strong><fmt:formatNumber value="${itemsVO.total_price}" pattern="#,###" /></strong><br>
            <span style="font-size: 0.8em;">포인트: <fmt:formatNumber value="${itemsVO.item_point}" pattern="#,###" /></span>
          </td>
