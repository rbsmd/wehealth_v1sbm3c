...
<jsp:include page="../menu/top.jsp" flush='false' />
  ...
  <DIV class='content_body' style='width: 100%;'>
    ...
    <c:forEach var="order_itemVO" items="${list }">
      ...
      <c:set var="itemsno" value ="${order_itemVO.itemsno}" />
      <c:set var="item_name" value ="${order_itemVO.item_name}" />
      <c:set var="total_price" value ="${order_itemVO.total_price}" />
    ...
    <TR>
      ...
      <TD class=td_basic><A href="/items/read.do?itemsno=${itemsno}">${itemsno}</A></TD>
      <TD class='td_left'>${item_name}</TD>
      <TD class='td_left'><fmt:formatNumber value="${total_price }" pattern="#,###" /></TD>
