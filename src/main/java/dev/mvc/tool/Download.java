...
public class Download extends javax.servlet.http.HttpServlet {
  ...
  protected void doProcess(HttpServletRequest request,
    ...
    // 저장 폴더를 절대 경로로 변환, /items/storage
    String dir = request.getParameter("dir");
    if (dir.equals("/items/storage")) {
        dir = Items.getUploadDir();
    }
...
//    } 
    ...
    // 완성된 경로 C:/kd1/ws_java/resort_v1sbm3c/src/main/resources/static/items/storage
    // dir =  System.getProperty("user.dir") + "/src/main/resources/static" + dir; // 절대 경로
    // 수정된 dir: C:/kd1/deploy/resort_v1sbm3c/items/storage/
